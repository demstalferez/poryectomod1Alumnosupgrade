...
def show_faq():
    ...
    st.markdown("""
    <div class="highlight">
        <p>Esta sección recopila las preguntas más comunes sobre el desafío de marketing. Si tienes alguna duda adicional, no dudes en contactar a tu mentor o enviar un email a demetrio.esteban@bootcamp-upgrade.com.</p>
    </div>
    ...
    - **Slack**: Canal #desafio-marketing
    - **Tutorías**: Agenda una sesión con tu mentor a través del calendario de Upgrade Hub
